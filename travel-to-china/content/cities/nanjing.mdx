...
weather: "Subtropical monsoon — four distinct seasons. The city is known for its 'furnace' summers (hot and humid) and its golden autumns when the plane tree boulevards turn amber. [Compare Nanjing's climate →](/comparison/climate/)"
highlights:
...
## Travel Styles for Nanjing

### <a id="budget-nanjing"></a>Budget Travel in Nanjing
...
### <a id="family-nanjing"></a>Family Travel in Nanjing
...
### <a id="business-nanjing"></a>Business Travel in Nanjing
...
### <a id="seniors-nanjing"></a>Senior-Friendly Nanjing Tips
...
<div class="related-routes">
  <h3>Popular Routes Including Nanjing</h3>
  <ul>
    <li><a href="/routes/144-hour-transit"><strong>144-Hour Transit (Shanghai Entry)</strong></a> — Nanjing is within the Shanghai coverage area for visa-free transit</li>
    <li><a href="/routes/themed/history"><strong>Imperial Capitals Tour (10-12 Days)</strong></a> — Beijing → Luoyang → Xi'an → Nanjing — China's four great ancient capitals</li>
  </ul>
</div>
