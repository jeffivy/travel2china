...
weather: "Subtropical monsoon — four distinct seasons. Spring: cherry blossoms and mist. Summer: hot, lotus blooms. Autumn: crisp, osmanthus-scented air. Winter: occasional snow on the lake. [Compare Hangzhou's climate →](/comparison/climate/)"
highlights:
...
## Travel Styles for Hangzhou

### <a id="budget-hangzhou"></a>Budget Travel in Hangzhou
...
### <a id="family-hangzhou"></a>Family Travel in Hangzhou
...
### <a id="business-hangzhou"></a>Business Travel in Hangzhou
...
### <a id="seniors-hangzhou"></a>Senior-Friendly Hangzhou Tips
...
<div class="related-routes">
  <h3>Popular Routes Including Hangzhou</h3>
  <ul>
    <li><a href="/routes/144-hour-transit"><strong>144-Hour Transit (Shanghai Entry)</strong></a> — Day trip from Shanghai, 45 minutes by train</li>
    <li><a href="/routes/themed/history"><strong>Ancient Towns & Water Villages (6 Days)</strong></a> — Shanghai → Suzhou → Hangzhou → Wuzhen</li>
  </ul>
</div>
